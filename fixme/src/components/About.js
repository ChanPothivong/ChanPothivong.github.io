                ...
                <div id="info-content">
                    <div className="info-box">
                        ...
                        <div className="what-we-do">
                            The Aptos team is made up of a highly accomplished team
                ...
                <div id="team">
                    ...
                    <div className="team-box">
                        ...
                        <div className="member-box">
                            {/* <div style="background-image: url('/Sor_Chandara.jpg');" className="photo"></div> */}
                        ...
                        <div className="member-box">
                            {/* <div style="background-image: url('/teb_yuma.jpg');" className="photo"></div> */}
                            <div className="team-name">
                                Teb Yuma
                            </div>
                        </div>
                        ...
                        <div className="member-box">
                            {/* <div style="background-image: url('/Chan_Pothivong.jpg');" className="photo"></div> */}
                            <div className="team-name">
                                Chan Pothivong
                            </div>
                        </div>
